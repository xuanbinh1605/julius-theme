    ...
    <section class="py-16 md:py-24 bg-background">
        <div class="container mx-auto px-4">
            ...
            <div class="max-w-5xl mx-auto">
                <?php
                $promo_group_image_id  = get_theme_mod( 'julius_promo_group_image', 0 );
                $promo_group_image_url = wp_get_attachment_image_url( $promo_group_image_id, 'full' );
                $promo_group_image_alt = get_theme_mod( 'julius_promo_group_image_alt', 'Julius promotion group special banner' );
                if ( $promo_group_image_url ) :
                ?>
                <img 
                    src="<?php echo esc_url( $promo_group_image_url ); ?>"
                    alt="<?php echo esc_attr( $promo_group_image_alt ); ?>"
                    class="promo-group-banner mb-4 rounded-2xl border border-border shadow-lg"
                    loading="lazy"
                    decoding="async"
                />
                <?php
