    ...
    <section class="py-16 md:py-24 bg-[#2D2418]">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <p class="text-primary text-sm tracking-[0.2em] uppercase mb-3 font-medium">Special Offers</p>
                <h2 class="text-3xl md:text-4xl font-bold text-white mb-4 text-balance">Julius Promotion</h2>
                <p class="text-white/70 max-w-xl mx-auto">Julius 1 &amp; Julius Signature (Julius 2)</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto mb-8">
                ...
                <div class="relative rounded-xl p-6 border transition-all bg-primary/15 border-primary shadow-lg shadow-primary/10">
                    ...
                    <div class="flex items-center justify-center gap-2 mb-4 mt-1">
                        ...
                        <span class="font-bold text-lg text-primary">9:00 - 18:00</span>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start gap-2">
                            ...
                            <p class="text-sm leading-relaxed text-white font-medium">40% OFF all services</p>
                        </div>
                        <div class="flex items-start gap-2">
                            <div class="w-1.5 h-1.5 rounded-full mt-1.5 flex-shrink-0 bg-primary"></div>
                            <p class="text-sm leading-relaxed text-white/60">No pick-drop service</p>
                        </div>
                        <div class="flex items-start gap-2">
                            <div class="w-1.5 h-1.5 rounded-full mt-1.5 flex-shrink-0 bg-primary"></div>
                            <p class="text-sm leading-relaxed text-white/60">Aroma 90min only 294,000 VND (Tip separate)</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative rounded-xl p-6 border transition-all bg-white/5 border-white/10">
                    <div class="flex items-center justify-center gap-2 mb-4 mt-1">
                        ...
                        <span class="font-bold text-lg text-white">18:01 - 22:00</span>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start gap-2">
                            ...
                            <p class="text-sm leading-relaxed text-white font-medium">Option 1: 20% OFF all courses on menu (No pick-drop)</p>
                        </div>
                        <div class="flex items-start gap-2">
                            <div class="w-1.5 h-1.5 rounded-full mt-1.5 flex-shrink-0 bg-white/40"></div>
                            <p class="text-sm leading-relaxed text-white font-medium">Option 2: FREE pick-drop for 2+ people within Da Nang (No discount)</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative rounded-xl p-6 border transition-all bg-white/5 border-white/10">
                    <div class="flex items-center justify-center gap-2 mb-4 mt-1">
                        ...
                        <span class="font-bold text-lg text-white">After 22:00</span>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start gap-2">
                            <div class="w-1.5 h-1.5 rounded-full mt-1.5 flex-shrink-0 bg-white/40"></div>
                            <p class="text-sm leading-relaxed text-white/60">No discount &amp; No pick-drop service</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="rounded-xl bg-primary/10 border border-primary/30 p-5 md:p-6">
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-4">
                        ...
                        <div class="md:ml-auto text-white/80 text-sm">
                            <span class="text-primary font-semibold">FREE pickup</span> within Da Nang for group of 4 | <span class="text-primary font-semibold">FREE 1 person</span> for group of 5+
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-5xl mx-auto mb-10">
                <div class="flex flex-wrap justify-center gap-x-6 gap-y-2">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-white/60 text-xs md:text-sm">5% more discount for re-visit (not for happy hour)</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-star w-3.5 h-3.5 text-primary flex-shrink-0">
                            <path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path>
                        </svg>
                        <span class="text-white/60 text-xs md:text-sm">5% more discount if you leave a review (not for re-visit)</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-star w-3.5 h-3.5 text-primary flex-shrink-0">
                            <path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path>
                        </svg>
                        <span class="text-white/60 text-xs md:text-sm">Car surcharge for pick-drop outside Da Nang city</span>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-6 bg-white/5 rounded-xl border border-white/10 p-5 md:p-6">
                    <div class="flex flex-col sm:flex-row gap-4 sm:gap-8 text-sm">
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                <p class="text-white font-medium">Julius 1</p>
                                <p class="text-white/60 text-xs">05 An Thuong 38, Da Nang</p>
                                <div class="flex items-center gap-1 mt-0.5">
                                    ...
                                    <a href="tel:0775509057" class="text-primary text-xs hover:underline">0775 509 057</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                <p class="text-white font-medium">Julius 2</p>
                                <p class="text-white/60 text-xs">61 Ta My Duat, Da Nang</p>
                                <div class="flex items-center gap-1 mt-0.5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-phone w-3 h-3 text-primary">
                                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                                    </svg>
                                    <a href="tel:0787509157" class="text-primary text-xs hover:underline">0787 509 157</a>
                                </div>
                            </div>
                        </div>
                    </div>

                    <a data-slot="button" class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive bg-primary text-primary-foreground hover:bg-primary/90 h-10 rounded-md px-6 has-[>svg]:px-4 flex-shrink-0" href="/contact">
                        Book Now
                    </a>
                </div>
            </div>
