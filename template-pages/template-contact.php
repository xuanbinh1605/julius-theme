...
<section class="relative min-h-screen flex flex-col lg:flex-row contact-hero-section">
...
<section class="relative py-20 md:py-28">
    ...
    <div class="relative z-10 container mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:<?php echo esc_attr( get_theme_mod( 'julius_loc1_phone', '0775509057' ) ); ?>">
